...
Но вреден север для меня
        ...
        assertEquals("БРА", longestCommonSubstring("АБРАКОДАБРА", "КОБРА"))
        assertEquals("ADADADADAD",
            longestCommonSubstring("DADADADADPADADADADAD", "DADADADADADADADADADADADADADADA"))
    }
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(0, calcPrimesNumber(-100000000))
        assertEquals(484129, calcPrimesNumber(7117171))
    }
}